...
def test_fetch_returns_the_xcom_pulled_path(tmp_path):
...
def test_fetch_raises_when_the_xcom_path_does_not_exist(tmp_path):
    ti = MagicMock()
...
def test_fetch_uses_a_custom_xcom_key():
    ti = MagicMock()
    ti.xcom_pull.return_value = None
